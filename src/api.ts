...
export async function sendCredential(name: string, email: string, grade: string) {
    ...
    await fetch('https://prod-21.westcentralus.logic.azure.com:443/workflows/13aec61e224c44cfaa2f8a6a235c01af/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=rbogeJLeBXcZbnoB2IexQS9LpK_ksEOd8r-vAGwYZAI', {
        method: 'POST',
        headers,
