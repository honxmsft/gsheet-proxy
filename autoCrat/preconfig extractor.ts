function autoCrat_extractorWindow() {
  ...
  var labelText =
    "Copying a Google Spreadsheet copies scripts along with it, but without any of the script settings saved.  This normally makes it hard to share full, script-enabled Spreadsheet systems. ";
  labelText +=
    ' You can solve this problem by pasting the code below into a script file called "paste preconfig here" (go to Script Editor and look in left sidebar of the autoCrat script) prior to publishing your Spreadsheet for others to copy. \n';
  labelText +=
    ' After a user copies your spreadsheet, they will select "Run initial installation."  This will preconfigure all needed script settings.  If you copied this system from someone as a spreadsheet, this has probably already been done for you.';
